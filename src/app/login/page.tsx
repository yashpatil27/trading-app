          ...
          <form className="space-y-6" onSubmit={handleLogin}>
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3 bg-zinc-800 border border-gray-600 rounded-lg text-white placeholder-gray-400 focus:border-white focus:ring-1 focus:ring-white"
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full px-4 py-3 pr-12 bg-zinc-800 border border-gray-600 rounded-lg text-white placeholder-gray-400 focus:border-white focus:ring-1 focus:ring-white"
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-white hover:bg-zinc-800 text-black hover:text-white font-semibold py-3 px-4 rounded-lg transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
            >
              {loading ? (
                <>
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className={`w-full px-4 py-3 pr-12 bg-zinc-800 border rounded-lg text-white placeholder-gray-400 focus:ring-1 ${
