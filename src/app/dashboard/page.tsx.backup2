...
import { TrendingUp, TrendingDown, History, LogOut, Home, Plus, Minus, ArrowDownLeft, ArrowUpRight, ArrowUp, ArrowDown, Wallet, Circle } from 'lucide-react'
              ...
              <div className="space-y-3">
                {recentTransactions.length === 0 ? (
                  <div className="text-gray-400 text-center py-8">
                    <Circle className="text-gray-600 mx-auto mb-2" width={48} height={48} />
            ...
            <div className="space-y-3">
              {transactions.length === 0 ? (
                <div className="text-gray-400 text-center py-12">
                  <Circle className="text-gray-600 mx-auto mb-4" width={64} height={64} />
